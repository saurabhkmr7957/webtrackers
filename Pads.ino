...
#define tftPORTRAIT_NORMAL       2
#define tftLANDSCAPE_INVERT      3
#define tftPORTRAIT_INVERT       4

#define border_colour YELLOW
#define num_button_colour RED
#define key_button_colour WHITE
#define yes_no_button_colour GREEN
#define num_text_colour BLACK
#define MENU 0
#define ALPHA 1
#define NUMERIC 2
#define YESNO 3
...
void showAlphaPad(int x, int y) {
  ...
  //ClearScreen();
  tft.fillRect(0, 0, 319, 239, BLACK);
  tft.drawRoundRect(x - 5, y - 5, 255, 105, 10, ILI9341_YELLOW);
  //  first row
  int keyx = x;
  int keyy = y;
  tft.fillRoundRect(keyx, keyy, 20, 20, 5, WHITE);
  ...
  keyx = x + 75;
  keyy = y + 75;
  tft.fillRoundRect(keyx, keyy, 70, 20, 5, WHITE);
  tft.setTextColor(BLACK, WHITE);
...
void showYesNo(int x, int y) {
  ...
  tft.setTextColor(BLACK, yes_no_button_colour);
