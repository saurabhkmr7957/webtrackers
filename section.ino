...
void  drawHomeMenu()  {           //  main menu for all settings (Leds, Time, etc...) 6 buttons
  ...
  /*  Button 2(ATTENDANCE) - Horizontal, Vertical, Width, Height, Color  */
  ...
  /*  Button 3(REGISTRATION) - Horizontal, Vertical, Width, Height, Color  */
  ...
  /*  Button 4("DEVICE INFO") - Horizontal, Vertical, Width, Height, Color  */
  ...
  /*  Button 5(ANALYTICS) - Horizontal, Vertical, Width, Height, Color  */
  ...
  /*  Button 6("SETTINGS") - Horizontal, Vertical, Width, Height, Color - This section is commented out if using Settings button  */
...
void  drawDashBoard()  {          //  where Time & Date, Temperature & Humidity are displayed
  ...
  tft.setCursor(60, 85);
  tft.print("00");    //draw minutes
  tft.setTextColor(GREY);
  tft.print(":");
  tft.setTextColor(WHITE);
  tft.print("00");   //draw seconds
...
void  drawSoundOption()  {                      /*  using MenuColor variable  */
...
void DrawDeviceOption(){
  ...
  tft.drawRect(167.33, 42, 138.6, 51, BtnBorderColor);
  tft.setCursor(203.3, 62.25);
  tft.println("Register Device");
}


void  drawwifioption()  {                      /*  using MenuColor variable  */
...
void  drawokandbackbutton()  {                      /*  using MenuColor variable  */
...
void redBtn()
{
  ...
  tft.fillRect(GREENBUTTON_X, GREENBUTTON_Y, GREENBUTTON_W, GREENBUTTON_H, DarkGREY);
  drawFrame();
  tft.setTextColor(WHITE);
  tft.setTextSize(2);
...
void greenBtn()
{
  ...
  tft.fillRect(REDBUTTON_X, REDBUTTON_Y, REDBUTTON_W, REDBUTTON_H, DarkGREY);
  drawFrame();
  tft.setTextColor(WHITE);
  tft.setTextSize(2);
  tft.setTextDatum(MC_DATUM);
...
/*-------------------------------------------------------------------------------------------------------------*/
                                            /*DRAW REGISTRAION STAFF AND EMPLOYEE*/
void  drawRegOption()  {                      /*  using MenuColor variable  */
  ...
  tft.drawRect(14, 42, 138.6, 51, BtnBorderColor);
  tft.setCursor(53.3, 62.25);
  tft.println("Reg Staff");

  /*  Button 2 - Horizontal, Vertical, Width, Height, Color  */
  tft.drawRect(166.6, 41.25, 140, 52.5, BtnBorderColor);
  tft.drawRect(167.33, 42, 138.6, 51, BtnBorderColor);
  tft.setCursor(203.3, 62.25);
  tft.println("Reg Employee");
...
void drawdeviceinfo(){
    ...
    tft.print("this Device is Registered with");
    tft.setCursor(13.3, 82.5);
    tft.print("origantion ");
    tft.setCursor(13.3, 105);
    tft.print("webtrackers.co.in");
}

String drawRegDeviceinfo(String resp){
    tft.setTextSize(2);
    tft.setTextColor(TextColor);
    tft.setCursor(13.3, 60);
    tft.print("Registering Device");
    tft.setCursor(13.3, 82.5);
...
String drawRegstaffinfo(String msgone,String msgtwo, String Status){
    tft.setTextSize(1);
    tft.setTextColor(TextColor);
    tft.setCursor(13.3, 60);
    tft.print(msgone);
...
String drawRegstudentinfo(String msgone,String msgtwo, String Status){
    tft.setTextSize(1);
    tft.setTextColor(TextColor);
    tft.setCursor(13.3, 60);
    tft.print(msgone);
